...
更早完成项不在看板列内折叠展开。“查看全部成果”按钮打开独立、可滚动的成果档案，且包含今天完成的任务。成果档案根据当前屏幕可用区域扩展为接近全屏的大页面，日期与事项卡片采用自适应多列布局。顶部提供“按日期 / 按事项”切换，并在本次打开期间保留当前选择。
